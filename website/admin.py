...
def add_shop_items():
    if current_user.id == 1:
        ...
        if form.validate_on_submit():
            ...
            small_unit_of_measurement = form.small_unit_of_measurement.data  
            ...
            new_shop_item.unit_of_measurement = unit_of_measurement  
            new_shop_item.small_unit_of_measurement = small_unit_of_measurement
